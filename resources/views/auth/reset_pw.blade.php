...
<html lang="en">
    ...
    <body id="kt_body" class="bg-body">
                        ...
                        <div class="w-lg-500px p-10 p-lg-15 mx-auto">
                            ...
                            <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" action="#">
                                ...
                                <div class="text-center mb-10">
                                    <!--begin::Title-->
                                    <h4 class="text-dark mb-3">Silahkan masukkan password barumu {{$data->email}}</h4>
                                    <!--end::Title-->
                                    <!--begin::Link-->
        ...
        <script src="{{url('assets/js/custom/authentication/sign-in/reset_pw.js')}}"></script>
