            ...
            <div class="d-flex flex-column flex-column-fluid">
                ...
                <div class="d-flex flex-column flex-column-fluid text-center p-10 py-lg-15">
                    ...
                    <div class="pt-lg-10">
                        ...
                        <!--end::Logo-->
                        <!--begin::Message-->
                        <div class="fs-3 fw-bold text-muted mb-10">Anda telah bergabung di Virtual Congress.
                            Silahkan memilih event yang sesuai dengan kebutuhan anda.
                        <!--end::Message-->
                        <!--begin::Action-->
                    ...
                    <!--end::Wrapper-->
                    <!--begin::Illustration-->
                    <div class="d-flex flex-row-auto bgi-no-repeat bgi-position-x-center bgi-size-contain bgi-position-y-bottom min-h-100px min-h-lg-350px" style="background-image: url({{url('assets/media/images/welcome.png')}}"></div>
                    <!--end::Illustration-->
                </div>
                <!--end::Content-->
                <!--begin::Footer-->
