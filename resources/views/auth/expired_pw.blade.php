        ...
        <div class="d-flex flex-column flex-root">
            ...
            <div class="d-flex flex-column flex-column-fluid">
                ...
                <div class="d-flex flex-column flex-column-fluid text-center p-10 py-lg-15">
                    ...
                    <div class="pt-lg-10">
                        <!--begin::Logo-->
                        <h1 class="fw-bolder fs-2qx text-gray-800 mb-7">Link Reset Password Tidak Dapan Ditemukan</h1>
                        <!--end::Logo-->
                        <!--begin::Message-->
                        <div class="fs-3 fw-bold text-muted mb-10">Link anda tidak ditemukan atau telah kadaluarsa. Silahkan kembali ke halaman lupa password untuk mendapatkan link reset password
                        <!--end::Message-->
                        <!--begin::Action-->
                        <div class="w-lg-600px p-10  mx-auto">
                            <button type="button" class="btn btn-lg btn-primary w-100 mb-5"
                            onclick="location.href='{{url('lupa_password')}}'" >
                            <span class="svg-icon svg-icon-2">
                                </span> <span class="indicator-label">
                                     Kembali Ke Lupa Password</span>
                            </button>
                        </div>
                        <!--end::Action-->
                        <!--begin::Action-->
