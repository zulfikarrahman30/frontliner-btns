        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">List Nasabah</h1>
                    <!--end::Title-->
                    <!--begin::Separator-->
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <li class="breadcrumb-item text-muted">
                            <a href="../../demo1/dist/index.html" class="text-muted text-hover-primary">Manager</a>
                        </li>
                        <!--end::Item-->
                        <!--begin::Item-->
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">List Nasabah</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
                                    ...
                                    <!--end::Separator-->
                                    <!--begin::Content-->
                                    <form class="form" action="{{ url('/layanan/assignment_index') }}">
                                        <div class="px-7 py-5" data-kt-user-table-filter="form">
                                            ...
                                            <div class="mb-10" id="sumber_data" style="display: none">
                                                ...
                                                <select class="form-select form-select-solid fw-bolder"
                                                    data-kt-select2="true" data-placeholder="Select option"
                                                    data-allow-clear="true" data-kt-user-table-filter="berdasarkan"
                                                    data-hide-search="true" name="sumber_data">
                                                    <option></option>
                                            ...
                                            <td class="text-end">
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a href="{{ url('layanan/assignment_edit/' . $item['id']) }}"
                                                    ...
                                                    <!--begin::Menu item-->
                                                    <div class="menu-item px-3">
                                                        <a href="{{ url('layanan/assignment_detail_riwayat/' . $item['id']) }}"
                                                            class="menu-link px-3">Detail</a>
                                                    </div>
                                                    <!--end::Menu item-->
                                                     <!--begin::Menu item-->
                                                    <div class="menu-item px-3">
                                                        <a href="{{ url('layanan/assignment_delete/' . $item['id']) }}"
