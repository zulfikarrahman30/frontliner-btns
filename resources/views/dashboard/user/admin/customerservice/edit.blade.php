    ...
    <div class="col-xl-12">
        ...
        <div class="card card-flush h-lg-100" id="kt_contacts_main">
            ...
            <div class="card-body pt-5">
                <!--begin::Form-->
                <form class="form" action="{{ url('user/customer_service_update/' . $data->user->id) }}" method="post"
                        ...
                        <div class="mt-1">
                            ...
                            <div class="image-input image-input-outline" data-kt-image-input="true"
                                ...
                                <div class="image-input-wrapper w-100px h-100px"
                                    style="background-image: url('{{ url('/') }}/admin/image/profile/customer_service/{{ $data->photo }}')">
                                </div>
                    ...
                    <div class="d-flex justify-content-end">
                        ...
                        <a href="{{ url('/user/customer_service_index') }}" class="btn btn-danger me-3">
