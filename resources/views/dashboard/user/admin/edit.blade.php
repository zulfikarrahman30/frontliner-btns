    ...
    <div class="col-xl-12">
        ...
        <div class="card card-flush h-lg-100" id="kt_contacts_main">
            ...
            <div class="card-body pt-5">
                <!--begin::Form-->
                <form class="form" action="{{ url('user/admin_update/' . $data->user->id) }}" method="post"
                        ...
                        <div class="mt-1">
                            ...
                            <div class="image-input image-input-outline" data-kt-image-input="true"
                                ...
                                <div class="image-input-wrapper w-100px h-100px"
                                    style="background-image: url('{{ url('/') }}/admin/image/profile/admin/{{ $data->photo }}')">
                                </div>
                                ...
                                <span class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow"
                                    data-kt-image-input-action="cancel" data-bs-toggle="tooltip" title="Cancel Foto">
                    ...
                    <div class="fv-row mb-7">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="email" onblur="validateEmail(this);" readonly class="form-control form-control-solid"
