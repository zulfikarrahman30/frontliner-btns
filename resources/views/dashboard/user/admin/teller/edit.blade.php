    ...
    <div class="col-xl-12">
        ...
        <div class="card card-flush h-lg-100" id="kt_contacts_main">
            ...
            <div class="card-body pt-5">
                <!--begin::Form-->
                <form class="form" action="{{ url('user/teller_update/' . $data->user->id) }}" method="post"
                        ...
                        <div class="mt-1">
                            ...
                            <div class="image-input image-input-outline" data-kt-image-input="true"
                                ...
                                <div class="image-input-wrapper w-100px h-100px"
                                    style="background-image: url('{{ url('/') }}/admin/image/profile/teller/{{ $data->photo }}">
                                </div>
                        ...
                        <div class="col">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <input type="text" required class="form-control form-control-solid"
                                    onkeypress="return hanyaAngka(event)" name="phone" value="{{ $data->phone }}" />
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                        </div>
