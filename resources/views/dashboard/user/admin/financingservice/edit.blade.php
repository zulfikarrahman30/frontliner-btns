    ...
    <div class="col-xl-12">
        ...
        <div class="card card-flush h-lg-100" id="kt_contacts_main">
            ...
            <div class="card-body pt-5">
                <!--begin::Form-->
                <form class="form" action="{{ url('user/financing_service_update/' . $data->user->id) }}" method="post"
                        ...
                        <div class="mt-1">
                            ...
                            <div class="image-input image-input-outline" data-kt-image-input="true"
                                ...
                                <div class="image-input-wrapper w-100px h-100px"
                                    style="background-image: url('{{ url('/') }}/admin/image/profile/financing_service/{{ $data->photo }}')">
                                </div>
                    ...
                    <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                        ...
                        <div class="col">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="email" onblur="validateEmail(this);" readonly
                        ...
                        <div class="col">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <input type="text" onkeypress="return hanyaAngka(event)" required
                                    class="form-control form-control-solid" name="phone" value="{{ $data->phone }}" />
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                        </div>
