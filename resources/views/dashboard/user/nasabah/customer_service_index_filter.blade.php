                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
                                    ...
                                    <!--end::Separator-->
                                    <!--begin::Content-->
                                    <form class="form" action="{{ url('/layanan/customer_service_submission_index') }}">
                                ...
                                @if (Auth::user()->role == 'customer_service')
                                    ...
                                    <a class="btn btn-primary"
                                        href="{{ url('/layanan/customer_service_submission_create') }}">
                            ...
                            <tbody class="text-gray-600 fw-bold">
                                @foreach ($data as $key => $item)
                                    ...
                                    <tr>
                                        ...
                                        <!--end::Sumber Data=-->
                                        <!--begin::Tipe=-->
                                        <td>{{ ucwords(str_replace('_', ' ', $item->tipe_nasabah ?? '')) }}</td>
                                        <!--end::Tipe=-->
                                        <!--begin::Jenis=-->
                                        <td>{{ ucwords(str_replace('_', ' ', $item->kategori_nasabah ?? '')) }}</td>
                                        <!--end::Jenis=-->
                                        <!--begin::Status-->
                                        ...
                                        <td class="text-end">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="{{ url('layanan/customer_service_submission_edit/' . $item->id) }}"
                                                        class="menu-link px-3">Edit</a>
                                                </div>
                                                <!--end::Menu item-->
                                                <!--begin::Menu item-->
                                                <div class="menu-item px-3">
                                                    <a href="{{ url('layanan/customer_service_submission_delete/' . $item->id) }}"
