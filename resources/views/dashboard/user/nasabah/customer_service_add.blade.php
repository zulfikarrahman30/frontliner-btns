            ...
            <div class="card card-flush h-lg-100" id="kt_contacts_main">
                ...
                <div class="card-body pt-12">
                    ...
                    <div class="row fv-row mb-7">
                        ...
                        <div class="w-50">
                            <!--begin::Select2-->
                            <select required class="form-select form-select-solid" name="job_status"
                                data-kt-ecommerce-settings-type="select2_flags" data-placeholder="Pilih Jenis">
                ...
                <div class="row fv-row mb-7">
                    ...
                    <div class="w-50">
                        ...
                        <select class="form-select form-select-solid" required name="service"
                            ...
                            <option value="administrasi_daftar_rehabilitasi_nasabah">Administrasi Daftar Rehabilitasi Nasabah</option>
                            ...
                            <option value="administrasi_resi_permintaan_pengembalian_buku_cek">Administrasi Resi Permintaan Pengembalian Buku Cek</option>
